...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:
        # Pet Image Label is a Dog and Classifier Label is a Dog
        ...
        elif results_dic[key][0] in dognames_dic and results_dic[key][1] not in dognames_dic:
            results_dic[key].extend((1, 0))

        # Pet Image Label is NOT a Dog and Classifier Label is a Dog
        elif results_dic[key][0] not in dognames_dic and results_dic[key][1] in dognames_dic:
            results_dic[key].extend((0, 1))

        # Pet Image Label is NOT a Dog and Classifier Label is NOT a Dog
        else:
