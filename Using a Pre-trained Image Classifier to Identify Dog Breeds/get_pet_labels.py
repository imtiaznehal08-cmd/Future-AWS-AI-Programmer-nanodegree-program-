...
def get_pet_labels(image_dir):
    ...
    # Creates an empty dictionary to store the results
    results_dic = dict()
    
    # Process each filename in the folder
    for filename in filename_list:
        ...
        # Create an empty string for the pet name
        pet_name = ""
        
        # Loop through the words, keeping only alphabetic characters
